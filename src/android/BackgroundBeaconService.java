...
public class BackgroundBeaconService extends Service implements BootstrapNotifier {
    ...
    public void onCreate() {
        ...
        iBeaconManager.setBackgroundBetweenScanPeriod(90000);
        iBeaconManager.setBackgroundScanPeriod(30000);
        // Simply constructing this class and holding a reference to it
        // enables auto battery saving of about 60%
        backgroundPowerSaver = new BackgroundPowerSaver(this);
        iBeaconManager.setDebug(true);

        Region region = new Region("backgroundRegion", Identifier.parse("b9407f30-f5f8-466e-aff9-25556b57fe6d"), Identifier.parse("5"), Identifier.parse("1000"));
